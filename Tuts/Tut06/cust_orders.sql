...
ALTER TABLE customer
    ADD CONSTRAINT chk_custlevel CHECK ( cust_level IN ( 'B',
                                                         'G',
                                                         'S' ) );
...
CREATE TABLE orderline (
    ...
    ol_qtyordered  VARCHAR2(50) NOT NULL,
    ol_lineprice   VARCHAR2(50) NOT NULL
);
...
CREATE TABLE prod_category (
    "pcat-id"  NUMBER(7) NOT NULL,
    pcat_name  VARCHAR2(50) NOT NULL
);

COMMENT ON COLUMN prod_category."pcat-id" IS
    'category id';

COMMENT ON COLUMN prod_category.pcat_name IS
    'category name';

ALTER TABLE prod_category ADD CONSTRAINT prod_category_pk PRIMARY KEY ( "pcat-id" );
...
COMMENT ON COLUMN product."pcat-id" IS
    'category id';
...
ALTER TABLE product
    ADD CONSTRAINT pcat_product FOREIGN KEY ( "pcat-id" )
        REFERENCES prod_category ( "pcat-id" );
